    ...
    <main class="flex-1 p-6 overflow-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div class="bg-white p-4 rounded-lg shadow-sm border border-slate-200 border-l-4 border-l-amber-500">
                <p class="text-sm text-slate-500 font-medium">1〜5月 販売数昨対比</p>
            ...
            <div class="bg-white p-4 rounded-lg shadow-sm border border-slate-200">
                <p class="text-sm text-slate-500 font-medium">総供給見込み (6月〜)</p>
            ...
            <div class="bg-white p-4 rounded-lg shadow-sm border border-slate-200">
                <p class="text-sm text-slate-500 font-medium">需要予測 (6〜12月)</p>
        ...
        <div x-show="activeTab === 'summary'" class="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
            ...
            <p class="text-slate-600 mb-6">
                1〜5月の販売数は前年比<span x-text="kpi.sales_ratio" class="font-bold"></span>%と非常に高いお客様の需要を示していますが、皆様もご存知の通り、一部カラーで在庫切れが発生しており、供給が追いついていません。<br>
